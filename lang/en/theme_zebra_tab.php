...
/**
 * zebra_tab theme English language strings
 *
...
$string['pluginname'] = 'Zebra for Tablets';
$string['choosereadme'] = '<div class="clearfix">
	<h1>Zebra for Tablets</h1>
        <hr>
	<div style="float:right;margin-left:4px;">
		<img src="zebra_tab/pix/screenshot.jpg" />
	</div>
	<div>
	    <p><span class="warning">Warning:</span> Zebra for Tablets 2.0+ relies heavily on CSS3 and is <u>NOT recommended</u> for IE6 or below, but then, neither is Moodle 2.0+.</p>
	    <br />
		<h2>About</h2>
		<p>Zebra for Tablets uses CSS3 <code>@media</code> queries to dynamically reflow the page layout based on screen width.  This custom 2-1-3 (middle, left, right) page layout can display 1, 2, or 3 columns depending on screen width.  It is also compatible with <code>.side-pre-only</code>, <code>.side-post-only</code>, and <code>.content-only</code> body classes in all 3 layouts.</p>
        <br />
        <p>Zebra for Tablets also provides extensive customization via its settings page, including colors, logos, reflow settings, mobile settings, and a custom CSS field.</p>
		<h2>Parents</h2>
		<p>This theme is built upon Base and integrates the pagelayout and dock from Rebase.</p>
		<h2>Credits</h2>
		<p>Zebra for Tablets 2.0 is based off of the original Aardvark 1.2 (1.9) by Shaun Daubney @ Newbury-College, Zebra for Tablets 1.4 (1.9) by me (Danny Wahl) @ iyWare, Aardvark_makeover (2.0) by Mary Evans @ Visible-Expressions, and whatever themes those themes are based off of.</p>
		<h2>License</h2>
		...
		<h2>Theme Plugin URL:</h2>
                <p><a href="http://moodle.org/plugins/view.php?plugin=theme_zebra_tab">http://moodle.org/plugins/view.php?plugin=theme_zebra_tab</a></p>
                <h2>Theme Credits</h2>
		<p><a href="http://iyware.com">Danny Wahl</a></p>
                <h2>Don\'t forget to customize your settings!</h2>
                <a href="../admin/settings.php?section=themesettingzebra_tab">Zebra for Tablets Theme Settings</a>
	</div>
</div>
';
...
$string['columninfodesc'] = '<p>Change the settings for the layout of the page.  To test your settings simply resize your browser window or rotate the orientation of your phone/tablet.</p><figure style="float: left;"><img src="../theme/image.php?theme=zebra_tab&image=core/one_column&component=theme"/><figcaption><ul><li>top: <code>region-main</code></li><li>middle: <code>region-pre</code></li><li>bottom: <code>region-post</code></li></ul></figcaption></figure><figure style="float: left;"><img src="../theme/image.php?theme=zebra_tab&image=core/two_columns&component=theme"/><figcaption><ul><li>top left: <code>region-pre</code></li><li>bottom left: <code>region-post</code></li><li>right: <code>region-main</code></li></ul></figcaption></figure><figure style="float: left;"><img src="../theme/image.php?theme=zebra_tab&image=core/three_columns&component=theme"/><figcaption><ul><li>left: <code>region-pre</code></li><li>center: <code>region-main</code></li><li>right: <code>region-post</code></li></ul></figcaption></figure><br style="clear: left;" />';
