...
$string['choosereadme'] = '<div class="clearfix">
	<h2>bLearning</h2>
        <hr>
		<h3>About</h3>
		<p>bLearning is a mobile-first, responsive theme that uses CSS3 to reflow the layout for the best experience on every device.</p>
        <p>bLearning also provides extensive customization via its settings page, including colors, logos, responsive settings, and custom CSS and JavaScript options.</p>
		<h3>Parents</h3>
		...
		<p>This theme utilizes other open source libraries and the rights of those libraries belong to their authors.  More information can be found on the <a href="../admin/settings.php?section=themesettingblearning">bLearning Theme Settings</a> page.</p>
        ...
        <p><a href="https://moodle.org/plugins/view.php?plugin=theme_blearning">http://moodle.org/plugins/view.php?plugin=theme_blearning</a></p>
        <h3>Theme Credits</h3>
