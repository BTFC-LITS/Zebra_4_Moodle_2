...
/**
 * zebra_tab theme library functions
 *
 ...
 */
function zebra_tab_process_css($css, $theme) {
    ...
    $css = zebra_tab_set_backgroundurl($css, $backgroundurl);
    ...
    $css = zebra_tab_set_colorscheme($css, $colorscheme);
    ...
    $css = zebra_tab_set_menucolorscheme($css, $menucolorscheme);
    ...
    $css = zebra_tab_set_homeiconcolor($css, $menucolorscheme);
    ...
    $css = zebra_tab_set_hmenuiconcolor($css, $menucolorscheme);
    ...
    $css = zebra_tab_set_vmenuiconcolor($css, $menucolorscheme);
    ...
    $css = zebra_tab_set_bodybgcolor($css, $bodybgcolor);
    ...
    $css = zebra_tab_set_linkcolor($css, $linkcolor);
    ...
    $css = zebra_tab_set_hovercolor($css, $hovercolor);
    ...
    $css = zebra_tab_set_fontcolor($css, $fontcolor);
    ...
    $css = zebra_tab_set_contentbgcolor($css, $contentbgcolor);
    ...
    $css = zebra_tab_set_columnbgcolor($css, $columnbgcolor);
    ...
    $css = zebra_tab_set_headerbgcolor($css, $headerbgcolor);
    ...
    $css = zebra_tab_set_footerbgcolor($css, $footerbgcolor);
    ...
    $css = zebra_tab_set_bordercolor($css, $bordercolor);
    ...
    $css = zebra_tab_set_calcourse($css, $calcourse);
    ...
    $css = zebra_tab_set_calglobal($css, $calglobal);
    ...
    $css = zebra_tab_set_calgroup($css, $calgroup);
    ...
    $css = zebra_tab_set_caluser($css, $caluser);
    ...
    $css = zebra_tab_set_calweekend($css, $calweekend);
    ...
    $css = zebra_tab_set_okfontcolor($css, $okfontcolor);
    ...
    $css = zebra_tab_set_warningfontcolor($css, $warningfontcolor);
    ...
    $css = zebra_tab_set_seriousfontcolor($css, $seriousfontcolor);
    ...
    $css = zebra_tab_set_criticalfontcolor($css, $criticalfontcolor);
    ...
    $css = zebra_tab_set_twocolmin($css, $twocolmin);
    ...
    $css = zebra_tab_set_threecolmin($css, $threecolmin);
    ...
    $css = zebra_tab_set_pagemaxwidth($css, $pagemaxwidth);
    ...
    $css = zebra_tab_set_colwidth($css, $colwidth);
    ...
    $css = zebra_tab_set_doublecolwidth($css, $colwidth);
    ...
    $css = zebra_tab_set_useautohide($css, $useautohide, $hovercolor);
    ...
    $css = zebra_tab_set_customcss($css, $customcss);
 ...
 * @return string
 */
function zebra_tab_set_backgroundurl($css, $backgroundurl) {
    global $OUTPUT;
 ...
 * @return string
 */
function zebra_tab_set_bodybgcolor($css, $bodybgcolor) {
 ...
 * @return string
 */
function zebra_tab_set_linkcolor($css, $linkcolor) {
 ...
 * @return string
 */
function zebra_tab_set_hovercolor($css, $hovercolor) {
 ...
 * @return string
 */
function zebra_tab_set_fontcolor($css, $fontcolor) {
 ...
 * @return string
 */
function zebra_tab_set_contentbgcolor($css, $contentbgcolor) {
 ...
 * @return string
 */
function zebra_tab_set_columnbgcolor($css, $columnbgcolor) {
 ...
 * @return string
 */
function zebra_tab_set_headerbgcolor($css, $headerbgcolor) {
 ...
 * @return string
 */
function zebra_tab_set_footerbgcolor($css, $footerbgcolor) {
 ...
 * @return string
 */
function zebra_tab_set_bordercolor($css, $bordercolor) {
 ...
 * @return string
 */
function zebra_tab_set_calcourse($css, $calcourse) {
 ...
 * @return string
 */
function zebra_tab_set_calglobal($css, $calglobal) {
 ...
 * @return string
 */
function zebra_tab_set_calgroup($css, $calgroup) {
 ...
 * @return string
 */
function zebra_tab_set_caluser($css, $caluser) {
    $tag = '[[setting:caluser]]';
    if (is_null($caluser)) {
 ...
 * @return string
 */
function zebra_tab_set_calweekend($css, $calweekend) {
 ...
 * @return string
 */
function zebra_tab_set_okfontcolor($css, $okfontcolor) {
 ...
 * @return string
 */
function zebra_tab_set_warningfontcolor($css, $warningfontcolor) {
 ...
 * @return string
 */
function zebra_tab_set_seriousfontcolor($css, $seriousfontcolor) {
 ...
 * @return string
 */
function zebra_tab_set_criticalfontcolor($css, $criticalfontcolor) {
 ...
 * @return string
 */
function zebra_tab_set_colorscheme($css, $colorscheme) {
 ...
 * @return string
 */
function zebra_tab_set_menucolorscheme($css, $menucolorscheme) {
 ...
 * @return string
 */
function zebra_tab_set_homeiconcolor($css, $menucolorscheme) {
    global $OUTPUT;
 ...
 * @return string
 */
function zebra_tab_set_hmenuiconcolor($css, $menucolorscheme) {
    global $OUTPUT;
 ...
 * @return string
 */
function zebra_tab_set_vmenuiconcolor($css, $menucolorscheme) {
    global $OUTPUT;
 ...
 * Should be the returned value of {@link zebra_tab_set_onecolmax()}
 ...
 * @return string
 */
function zebra_tab_set_twocolmin($css, $twocolmin) {
 ...
 * Should be the returned value of {@link zebra_tab_set_twocolmax()}
 * plus 1. Default value should fit:
 * Tablet landscape
 * HDTV
 * Monitor
 ...
 * @return string
 */
function zebra_tab_set_threecolmin($css, $threecolmin) {
 ...
 * @return string
 */
function zebra_tab_set_pagemaxwidth($css, $pagemaxwidth) {
 ...
 * @return string
 */
function zebra_tab_set_colwidth($css, $colwidth) {
 ...
 * @return string
 */
function zebra_tab_set_doublecolwidth($css, $colwidth) {
 ...
 * @return string
 */
function zebra_tab_set_useautohide($css, $useautohide, $hovercolor) {
	global $CFG;
 ...
 * @return string
 */
function zebra_tab_set_customcss($css, $customcss) {
 ...
 * @return string
 */
function zebra_tab_print_logourl($logourl) {
    global $OUTPUT;
   $protocol = '://';
